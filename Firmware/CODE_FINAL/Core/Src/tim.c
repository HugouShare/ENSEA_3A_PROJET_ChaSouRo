...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM15_MspPostInit 0 */
    ...
    PB15     ------> TIM15_CH2
    */
    GPIO_InitStruct.Pin = LID_M_CTRL_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM15;
    HAL_GPIO_Init(LID_M_CTRL_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(GPIOA, ENC_PA_R_Pin|ENC_PB_R_Pin);
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PB8-BOOT0     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(ENC_PA_L_GPIO_Port, ENC_PA_L_Pin);

    HAL_GPIO_DeInit(ENC_PB_L_GPIO_Port, ENC_PB_L_Pin);
