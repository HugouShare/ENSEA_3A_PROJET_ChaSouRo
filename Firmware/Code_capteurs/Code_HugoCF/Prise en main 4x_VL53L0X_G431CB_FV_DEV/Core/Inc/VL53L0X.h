...
typedef struct
{
	...
	// XSHUT TOF 1
	GPIO_TypeDef* XSHUT_TOF1_GPIO_Port;
	uint16_t XSHUT_TOF1_GPIO_Pin;
	// XSHUT TOF 2
	GPIO_TypeDef* XSHUT_TOF2_GPIO_Port;
	uint16_t XSHUT_TOF2_GPIO_Pin;
	// XSHUT TOF 3
	GPIO_TypeDef* XSHUT_TOF3_GPIO_Port;
	uint16_t XSHUT_TOF3_GPIO_Pin;
	// XSHUT TOF 4
	GPIO_TypeDef* XSHUT_TOF4_GPIO_Port;
	uint16_t XSHUT_TOF4_GPIO_Pin;
}h_vl53l0x_t;
