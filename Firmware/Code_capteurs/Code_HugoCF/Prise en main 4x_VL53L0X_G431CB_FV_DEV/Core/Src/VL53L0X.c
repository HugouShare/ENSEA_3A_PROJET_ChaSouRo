...
bool VL53L0X_LibraryInit (bool io_2v8, I2C_HandleTypeDef *handler)
{
...
void VL53L0X_InitSingleTOF (h_vl53l0x_t * h_vl53l0x)
{
	...
	VL53L0X_LibraryInit(1, h_vl53l0x->hi2c);
...
{
	// Shut down of all the TOFs
	VL53L0X_XSHUT(h_vl53l0x->XSHUT_TOF1_GPIO_Port,h_vl53l0x->XSHUT_TOF1_GPIO_Pin,GPIO_PIN_RESET);
	VL53L0X_XSHUT(h_vl53l0x->XSHUT_TOF2_GPIO_Port,h_vl53l0x->XSHUT_TOF2_GPIO_Pin,GPIO_PIN_RESET);
	VL53L0X_XSHUT(h_vl53l0x->XSHUT_TOF3_GPIO_Port,h_vl53l0x->XSHUT_TOF3_GPIO_Pin,GPIO_PIN_RESET);
...
void VL53L0X_TIMx_Callback (h_vl53l0x_t * h_vl53l0x)
{
