...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_D2_Pin|Xshunt4_Pin|LED_D1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, Xshunt3_Pin|EN_BT_Pin|Xshunt2_Pin|Xshunt1_Pin, GPIO_PIN_RESET);
