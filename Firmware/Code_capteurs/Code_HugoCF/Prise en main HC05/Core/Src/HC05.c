...
////////////////////////////////////////////// VARIABLES
static TaskHandle_t h_task_h_hc05_tx = NULL;
...
void task_h_hc05_tx (h_hc05_t * h_hc05)
{
	/*
...
void task_hc05_rx (h_hc05_t * h_hc05)
{
	/*
	 * Le fonctionnement de cette tâche-ci est le suivant :
...
void HC05_Init (h_hc05_t * h_hc05)
{
	...
	if (xTaskCreate(task_h_hc05_tx, "h_hc05_tX", 256, h_hc05, 1, &h_task_h_hc05_tx) != pdPASS)
	{
		printf("\n\r Error creating task \n\r");
		Error_Handler();
	}
